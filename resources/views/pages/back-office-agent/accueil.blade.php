                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><b>{{ $position }}</b></td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'P')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'A et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'B et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'C et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'D et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Masculin')->where('categorie', 'E et assimilés')->where('position_agents', $position)->count() }}</td>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><b>{{ $position }}</b></td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'P')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'A et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'B et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'C et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'D et assimilés')->where('position_agents', $position)->count() }}</td>
                                <td>{{ $directionAgents->where('sexe', 'Feminin')->where('categorie', 'E et assimilés')->where('position_agents', $position)->count() }}</td>
                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><b>{{ $position }}</b></td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'P')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'A et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'B et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'C et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'D et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Masculin')->where('categorie', 'E et assimilés')->where('position_service', $position)->count() }}</td>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><b>{{ $position }}</b></td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'P')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'A et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'B et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'C et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'D et assimilés')->where('position_service', $position)->count() }}</td>
                                <td>{{ $serviceAgents->where('sexe', 'Feminin')->where('categorie', 'E et assimilés')->where('position_service', $position)->count() }}</td>
