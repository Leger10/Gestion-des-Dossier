            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <h5 class="card-title text-center text-bold text-uppercase">Creation compte utilisateur </h5><hr><br>
                        <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Rôle') }}</label>

                                    <div class="col-md-8">
                                        <select class="form-control" id="role" name="role">
                                            <option value="" selected disabled>Sélectionner le rôle</option>
                                            <option value="Administrateur" >Administrateur</option>
                                            <option value="Redacteur" >Superviseur</option>
                                            <option value="Lecteur" >Secretaire</option>
                                        </select>
                                ...
                                <div class="form-group row mb-0 right">
                                    <div class="col-md-12 col-md-offset-2 text-center">
                                        <a href="{{ route('dashbord.accueil') }}" class="btn btn-danger " ><i class="fa fa-close"></i> Annuler </a>
                                        <button type="submit" class="btn btn-success ">
                                                <i class="fa fa-check"></i> {{ __('Enregister') }}
                                        </button>
                                        <br> <br>
                                    </div>
                                </div>
